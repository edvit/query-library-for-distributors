...
View for reporting on Invoice and Credit Memo line detail.

```sql

/*CREATE VIEW  "DIST_Invoice_Lines" AS*/

/* All Invoice Lines(INV1) union with all credit note lines (RIN1).
Excludes cancelled order 
